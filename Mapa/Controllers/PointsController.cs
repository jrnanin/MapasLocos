...
namespace Mapa.Controllers
{
    ...
    {
        private readonly MapaContext _context;

        public PointsController(MapaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Latitude,Longitude,typePoint")] Point point)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Latitude,Longitude,typePoint")] Point point)
        {
            if (id != point.Id)
            {
                return NotFound();
